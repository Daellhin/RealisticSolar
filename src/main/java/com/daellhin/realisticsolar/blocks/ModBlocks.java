...
public class ModBlocks {
	...
	public static final RegistryObject<Item> ALUMINIUM_BLOCK_ITEM = ITEMS
			.register("aluminium_block", () -> new BlockItem(ALUMINIUM_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> ALUMINIUMORE_BLOCK_ITEM = ITEMS
			.register("aluminium_ore_block", () -> new BlockItem(ALUMINIUMORE_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> SILICASAND_BLOCK_ITEM = ITEMS
			.register("silica_sand_block", () -> new BlockItem(SILICASAND_BLOCK.get(), basicItemProperties));

	// solar panel
	public static final RegistryObject<Block> SOLARPANEL_BLOCK = BLOCKS.register(SolarPanelBlock.REGNAME, SolarPanelBlock::new);
	public static final RegistryObject<Item> SOLARPANEL_BLOCK_ITEM = ITEMS
			.register(SolarPanelBlock.REGNAME, () -> new BlockItem(SOLARPANEL_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> COALGENERATOR_BLOCK_ITEM = ITEMS
			.register(CoalGeneratorBlock.REGNAME, () -> new BlockItem(COALGENERATOR_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> ARCFURNACE_CONTROLLER_BLOCK_ITEM = ITEMS
			.register(ArcFurnaceControllerBlock.REGNAME, () -> new BlockItem(ARCFURNACE_CONTROLLER_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> ARCFURNACE_CASING_BLOCK_ITEM = ITEMS
			.register("arc_furnace_casing_block", () -> new BlockItem(ARCFURNACE_CASING_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> ARCFURNACE_ELECTRODE_BLOCK_ITEM = ITEMS
			.register("arc_furnace_electrode_block", () -> new BlockItem(ARCFURNACE_ELECTRODE_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> SIEMENSREACTOR_CONTROLLER_BLOCK_ITEM = ITEMS
			.register(SiemensReactorControllerBlock.REGNAME, () -> new BlockItem(SIEMENSREACTOR_CONTROLLER_BLOCK.get(), basicItemProperties));
	...
	public static final RegistryObject<Item> SIEMENSREACTOR_TOP_BLOCK_ITEM = ITEMS
			.register("siemens_reactor_top_block", () -> new BlockItem(SIEMENSREACTOR_TOP_BLOCK.get(), basicItemProperties));

	// common
	public static final RegistryObject<TileEntityType<SiemensReactorTile>> SIEMENSREACTOR_TILE = TILES
			.register(SiemensReactorControllerBlock.REGNAME, () -> TileEntityType.Builder.create(SiemensReactorTile::new, SIEMENSREACTOR_CONTROLLER_BLOCK.get())
					.build(null));
