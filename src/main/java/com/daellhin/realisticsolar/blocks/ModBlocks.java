...
public class ModBlocks {
	...
	// classless
	public static final RegistryObject<Block> ALUMINIUM_BLOCK = BLOCKS.register("aluminium_block", () -> new Block(Properties.of(Material.METAL)
			.sound(SoundType.METAL)
			.strength(2.0f)
			.harvestTool(ToolType.PICKAXE)));

	public static final RegistryObject<Block> ALUMINIUMORE_BLOCK = BLOCKS
			.register("aluminium_ore_block", () -> new Block(Properties.of(Material.STONE)
					.sound(SoundType.STONE)
					.strength(2.0f)
					.harvestTool(ToolType.PICKAXE)));

	public static final RegistryObject<Block> SILICASAND_BLOCK = BLOCKS
			.register("silica_sand_block", () -> new FallingBlock(Properties.of(Material.SAND)
	...
	public static final RegistryObject<TileEntityType<SolarPanelTile>> SOLARPANEL_TILE = TILES
			.register(SolarPanelBlock.REGNAME, () -> TileEntityType.Builder.of(SolarPanelTile::new, SOLARPANEL_BLOCK.get())
					.build(null));
	...
	public static final RegistryObject<TileEntityType<CoalGeneratorTile>> COALGENERATOR_TILE = TILES
			.register(CoalGeneratorBlock.REGNAME, () -> TileEntityType.Builder.of(CoalGeneratorTile::new, COALGENERATOR_BLOCK.get())
					.build(null));
	public static final RegistryObject<ContainerType<CoalGeneratorContainer>> COALGENERATOR_CONTAINER = CONTAINERS
			.register(CoalGeneratorBlock.REGNAME, () -> IForgeContainerType.create((windowId, inv, data) -> {
				return new CoalGeneratorContainer(windowId, inv.player.getCommandSenderWorld(), data.readBlockPos(), inv, inv.player);
			}));
	...
	public static final RegistryObject<TileEntityType<ArcFurnaceControllerTile>> ARCFURNACE_CONTROLLER_TILE = TILES
			.register(ArcFurnaceControllerBlock.REGNAME, () -> TileEntityType.Builder
					.of(ArcFurnaceControllerTile::new, ARCFURNACE_CONTROLLER_BLOCK.get())
					.build(null));
	...
	public static final RegistryObject<TileEntityType<ArcFurnacePortTile>> ARCFURNACE_PORT_TILE = TILES
			.register("arcfurnace_port", () -> TileEntityType.Builder
					.of(ArcFurnacePortTile::new, ARCFURNACE_ITEM_INPUT_PORT_BLOCK.get(), ARCFURNACE_ITEM_OUTPUT_PORT_BLOCK
	...
	public static final RegistryObject<ContainerType<ArcFurnaceContainer>> ARCFURNACE_CONTAINER = CONTAINERS
			.register(ArcFurnaceControllerBlock.REGNAME, () -> IForgeContainerType.create((windowId, inv, data) -> {
				return new ArcFurnaceContainer(windowId, inv.player.getCommandSenderWorld(), data.readBlockPos(), inv, inv.player);
			}));
	...
	public static final RegistryObject<TileEntityType<SiemensReactorTile>> SIEMENSREACTOR_TILE = TILES
			.register(SiemensReactorControllerBlock.REGNAME, () -> TileEntityType.Builder
					.of(SiemensReactorTile::new, SIEMENSREACTOR_CONTROLLER_BLOCK.get())
					.build(null));
	public static final RegistryObject<ContainerType<SiemensReactorContainer>> SIEMENSREACTOR_CONTAINER = CONTAINERS
			.register(SiemensReactorControllerBlock.REGNAME, () -> IForgeContainerType.create((windowId, inv, data) -> {
				return new SiemensReactorContainer(windowId, inv.player.getCommandSenderWorld(), data.readBlockPos(), inv, inv.player);
			}));
	...
	public static final RegistryObject<TileEntityType<HClBurnerTile>> HCL_BURNER_TILE = TILES
			.register(HClBurnerControllerBlock.REGNAME, () -> TileEntityType.Builder.of(HClBurnerTile::new, HCL_BURNER_CONTROLLER_BLOCK.get())
					.build(null));
	public static final RegistryObject<ContainerType<HClBurnerContainer>> HCL_BURNER_CONTAINER = CONTAINERS
			.register(HClBurnerControllerBlock.REGNAME, () -> IForgeContainerType.create((windowId, inv, data) -> {
				return new HClBurnerContainer(windowId, inv.player.getCommandSenderWorld(), data.readBlockPos(), inv, inv.player);
			}));

	// fancyblock
	public static final RegistryObject<FancyBlock> FANCYBLOCK = BLOCKS.register("fancyblock", FancyBlock::new);
	// public static final RegistryObject<Item> FANCYBLOCK_ITEM = ITEMS.register("fancyblock", () -> new BlockItem(FANCYBLOCK.get(), new
	// Item.Properties().group(ModSetup.ITEM_GROUP)));
	public static final RegistryObject<TileEntityType<FancyBlockTile>> FANCYBLOCK_TILE = TILES
			.register("fancyblock", () -> TileEntityType.Builder.of(FancyBlockTile::new, FANCYBLOCK.get())
					.build(null));

	// magicblock
	public static final RegistryObject<MagicBlock> MAGICBLOCK = BLOCKS.register("magicblock", MagicBlock::new);
	// public static final RegistryObject<Item> MAGICBLOCK_ITEM = ITEMS.register("magicblock", () -> new BlockItem(MAGICBLOCK.get(), new
	// Item.Properties().group(ModSetup.ITEM_GROUP)));
	public static final RegistryObject<TileEntityType<MagicTile>> MAGICBLOCK_TILE = TILES
			.register("magicblock", () -> TileEntityType.Builder.of(MagicTile::new, MAGICBLOCK.get())
					.build(null));
