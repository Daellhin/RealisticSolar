...
public enum EnumBlockSolarPanel {
    SolarPanelLow(0, "blockSolarPanelLow", 10), SolarPanelMed(1, "blockSolarPanelMed", 20),
    SolarPanelHigh(2, "blockSolarPanelHigh", 50), SolarPanelVHigh(3, "blockSolarPanelVHigh", 100),
