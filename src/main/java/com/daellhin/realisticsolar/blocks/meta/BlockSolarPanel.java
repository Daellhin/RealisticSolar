...
public class BlockSolarPanel extends Block implements ITileEntityProvider{
	...
	public void registerBlockIcons(IIconRegister reg) {
		...
		for(int i = 2; i < 6; i++) {this.icons[en.getMeta()][i] = reg.registerIcon(ModInfo.MOD_ID + ":" + "blockSolarPanel1");}
		}
	}
	...
	public TileEntity createNewTileEntity(World worldIn, int meta) {
		...
		switch(meta) { 
			case 0: maxGen=maxGen0; buffer=maxGen0; break;
			case 1: maxGen=maxGen1; buffer=maxGen1; break;
			case 2: maxGen=maxGen2; buffer=maxGen2; break;
			case 3: maxGen=maxGen3; buffer=maxGen3; break;
			case 4: maxGen=maxGen4; buffer=maxGen4; break;
		}
