...
public class Config {
	...
	ARCFURNACE_USAGE = COMMON_BUILDER.comment("Power usage per tick").defineInRange("generate", 1000, 0, Integer.MAX_VALUE);
	COALGENERATOR_RECEIVE = COMMON_BUILDER.comment("Max power received per tick").defineInRange("receive", 100, 0, Integer.MAX_VALUE);
