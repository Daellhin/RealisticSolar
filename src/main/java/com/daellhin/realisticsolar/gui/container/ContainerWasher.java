...
public class ContainerWasher extends Container{
	...
	public void addCraftingToCrafters(ICrafting crafter)
	{
		...
		crafter.sendProgressBarUpdate(this, 1, this.washer.stone);
	}
	...
	public void detectAndSendChanges()
	{
		...
		for(int i = 0; i < this.crafters.size(); i++)
		{
			...
			if(this.lastStoneContents != this.washer.stone)
			{
				crafter.sendProgressBarUpdate(this, 1, this.washer.stone);
			}
			
			this.lastProcessTime = this.washer.timeSpentProcessing;
			this.lastStoneContents = this.washer.stone;
		}
	}
	...
	{
		if(progressBar == 0) this.washer.timeSpentProcessing = var2;
		if(progressBar == 1) this.washer.stone = var2;
	}
	...
	public ItemStack transferStackInSlot(EntityPlayer player, int index)
	{
		...
		if (slot != null && slot.getHasStack())
        {
            ...
            {
                if (WasherRecipeHandler.processing().getProcessResult(itemstack1) != null)
                {
