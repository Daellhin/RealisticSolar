...
public enum EnumItemSiliconSolarCell {
	MultiSolarCellLow(0, "itemMultiSolarCellLow"),
	MultiSolarCellMed(1, "itemMultiSolarCellMed"),
	MultiSolarCellHigh(2, "itemMultiSolarCellHigh"),
	MonoSolarCellVHigh(3, "itemMonoSolarCellVHigh"),
